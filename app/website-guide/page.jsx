    ...
    <div className="bg-gray-900 text-white min-h-screen">
      <div className="container mx-auto p-4">
        ...
        <p className="capitalize">
          ...
          comments in the individual product&apos;s link. You can also add
          products to the cart and then make payment. Of course, the website is
          not real, and don&apos;t make real payments. You can add a product by
          clicking on your user icon and filling up the form. You will
          understand the rest...
        </p>
      </div>
      <div className="flex justify-center items-center">
